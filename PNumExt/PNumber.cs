...
namespace developingClasses
{
    public class PNumber
    {
        ...
        private static double translatorTo10(string value, int base_value, int accuracy)
        {
            ...
            if (ifNegative) result_integer *= -1;
        ...
        private static string translatorToP(double value, int base_value, int accuracy)
        {
        ...
        {
            return string.Format(this.valueNumber);
        }
